...
export class JobCardsReportComponent extends ReportBaseComponent<IEventsReportData | ITimeRangeValues[]>
{
	...
	public async runReportAsync(parameters: IRunReportParameters)
	{
		...
		if (Array.isArray(this.data)) {
			...
			DrawCategorizedStackedChart(this.title, Config.chartCanvasId, timerange, this.data, this.i18n, this.compareJobCards, this.formatJobCard);
		}
	}
}
